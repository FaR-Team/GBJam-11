...
{
    const string privateCode = "u-pv3v0t4kWssskauIGmNQyFcJGF9a0kSbkGf6cGGnfA";  //Key to Upload New Info
    const string publicCode = "650d88278f40bb0e382634d7";   //Key to download
